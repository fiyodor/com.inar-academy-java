...
public class Exercise_37 {
    ...
    public static void main(String[] args) {
        ...
        String[][] statesAndCapitals = getStateAndCapital();
        ...
        for (int i = 0; i < statesAndCapitals.length; i++) {
            ...
            if (equals(answer, statesAndCapitals[i][1])){
    ...
    private static boolean equals(String answer, String s) {
        ...
        String capital = s.toLowerCase();

        for (int i = 0; i < answerLowerCase.length(); i++) {

            if (answerLowerCase.charAt(i) != capital.charAt(i)){
    ...
    public static String[][] getStateAndCapital(){
