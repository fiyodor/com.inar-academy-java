package chapters.chapter_12.Exercises.Exercise_20;
...
public class Exercise_20 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (!directoryList.isEmpty()){
            ...
            deletePackageName(files, directoryList.get(0));
    ...
    public static void deletePackageName(ArrayList<File> list, File directory) throws Exception{
        ...
        for(int i = 0; i < list.size(); i++) {
          ...
          //  packageName.add("package " + directory.getName() + ";");
            ...
            packageName.remove(0); //bunu eklersek yeter
