    ...
    public static double computeTax(int status, double taxableIncome){
        ...
        if (status == 0) {
            ...
            if (taxableIncome <= 16700){
                ...
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137051) * 0.28 + (taxableIncome - 208851) * 0.33;
            }
            else {
                tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137051) * 0.28 + (372950 - 208851) * 0.33 + (taxableIncome - 372950) * 0.35;
            }
        }
        else if (status == 2) {
            ...
            if (taxableIncome <= 8350) {
                ...
                tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (taxableIncome - 186475) * 0.33;
            }
            else {
